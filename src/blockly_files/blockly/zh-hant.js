...
Blockly.Msg.GET_STATUS = "取得 %1 狀態資料.";
Blockly.Msg.SET_STATUS = "設定狀態資料 %1, 至 %2.";
Blockly.Msg.GET_VIBRATION_SENSOR = "取得震動感測器 %1 資料至 %2, %3, %4.";
Blockly.Msg.GET_SENSOR = "取得感測器 %1 資料";
Blockly.Msg.SET_SENSOR = "設定 %2 給感測器 %1.";
Blockly.Msg.GET_TIMER = "取得計時器 %1.";
Blockly.Msg.ONOFF_TIMER = "%2 計時器 %1.";
Blockly.Msg.RESET_TIMER = "重啟計時器 %1.";
Blockly.Msg.GET_COUNTER = "取得計數器 %1.";
Blockly.Msg.COUNT_COUNTER = "計數器 計數 %1";
Blockly.Msg.RESET_COUNTER = "重啟計數器 %1.";
Blockly.Msg.GET_GLOBAL = "取得全域變數 %1 資料";
Blockly.Msg.SET_GLOBAL = "設定 %2 給全域變數 %1.";
Blockly.Msg.IF = "如果 %1";
Blockly.Msg.IF_DO = "執行 %1";
Blockly.Msg.ELSE = "否則";
Blockly.Msg.ELSE_DO = "執行 %1";
Blockly.Msg.TURN_ON = "開啟";
Blockly.Msg.TURN_OFF = "關閉";
